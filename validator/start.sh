...
echo "Launching node"
/usr/local/bin/pyethapp --unlock 3 --validate 3 -m 0 --password /root/.config/pyethapp/password.txt -l :info,eth:debug,pow:debug --log-file /root/log/log.txt -b $BOOTSTRAP_NODE run
